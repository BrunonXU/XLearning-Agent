...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <div className="px-8 pb-8 pt-4 bg-transparent flex-shrink-0 w-full flex justify-center">
      <div className="relative w-full max-w-3xl flex items-end gap-2 rounded-3xl border border-[#E5E5E5] focus-within:border-[#D97757]/50 focus-within:ring-4 focus-within:ring-[#D97757]/10 bg-[#F9F9F9] px-5 py-2.5 transition-all duration-200 shadow-sm">
        <textarea
          ref={textareaRef}
          value={value}
